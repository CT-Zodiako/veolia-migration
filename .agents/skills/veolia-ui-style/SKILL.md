...
Nota: a la fecha de escritura de este skill, `proyecciones`,
`reliquidacion/reliq-crear`, `cra/indices-cra` y `subcont` TODAVÍA usan
`window.confirm()` — son candidatos pendientes de migrar, no un patrón a copiar.
