...
export class SidebarMenuService {
  ...
  private readonly routeCatalog: Array<SidebarMenuItem & { keywords: string[]; menuId?: number }> = [
    ...
    { label: 'Reliquidación - Crear', path: '/reliquidacion/crear', icon: '🧾', keywords: ['reliquidacion crear', 'reliq crear', 'reliquidacion'], menuId: 5001 },
    { label: 'Reliquidación - Cargue', path: '/reliquidacion/cargue', icon: '📥', keywords: ['reliquidacion cargue', 'reliq cargue'], menuId: 5002 },
    { label: 'Reliquidación - Comparar Costo', path: '/reliquidacion/comparar-costo', icon: '📊', keywords: ['comparar costo reliquidacion', 'reliq comparar costo'], menuId: 5003 },
    ...
    { label: 'Reliquidación - Aplicar en Tarifas', path: '/reliquidacion/tarificador', icon: '🧮', keywords: ['tarificador reliquidacion', 'reliq tarificador', 'aplicar en tarifas'], menuId: 6002 },
