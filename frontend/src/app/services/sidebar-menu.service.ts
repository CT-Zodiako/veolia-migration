...
export class SidebarMenuService {
  ...
  private readonly routeCatalog: Array<SidebarMenuItem & { keywords: string[]; menuId?: number }> = [
    ...
    { label: 'Subsidios y Contribuciones', path: '/subcont', icon: '💰', keywords: ['subcont', 'subsidios', 'contribuciones'], menuId: 302 },
    ...
    { label: 'Costo de Poda', path: '/gerencial/poda', icon: '🌿', keywords: ['costo poda gerencial', 'gerencial poda', 'infogerencial poda', 'costo de poda'], menuId: 606 },
