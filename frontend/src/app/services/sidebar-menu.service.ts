...
export class SidebarMenuService {
  ...
  private readonly routeCatalog: Array<SidebarMenuItem & { keywords: string[]; menuId?: number }> = [
    ...
    { label: 'Residuos Generados', path: '/residuosGenerados', icon: 'recycle', keywords: ['residuos generados'], menuId: 20001 },
    ...
    { label: 'SUI 853 - Carga genérica', path: '/cargaGenerica', icon: 'upload', keywords: ['carga generica', 'carga genérica'], menuId: 30006 },
