...
builder.Services.AddScoped<ITrnaRepository, TrnaRepository>();
builder.Services.AddScoped<ITafnaRepository, TafnaRepository>();
builder.Services.AddScoped<IUsuariosGraficoRepository, UsuariosGraficoRepository>();
